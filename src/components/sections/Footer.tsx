    ...
    <footer className="px-10 py-12 border-t border-slate-100 bg-white text-xs text-slate-400 font-medium">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:pr-12">
            ...
            <p className="leading-relaxed text-slate-500 text-sm">
              "The operational intelligence layer<br />for the physical world."
            </p>
          </div>

          {/* Column 2 */}
          <div>
            <h4 className="flex gap-6 uppercase tracking-wider text-slate-900 mb-6 font-bold">Company</h4>
          ...
          {/* Column 3 */}
          <div>
            <h4 className="flex gap-6 uppercase tracking-wider text-slate-900 mb-6 font-bold">Solutions</h4>
            <ul className="flex flex-col gap-4 text-sm text-slate-500">
          ...
          {/* Column 4 */}
          <div>
            <h4 className="flex gap-6 uppercase tracking-wider text-slate-900 mb-6 font-bold">Connect</h4>
            <ul className="flex flex-col gap-4 text-sm text-slate-500">
        ...
        <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold uppercase tracking-wider text-slate-400">
          <p>© 2026 Axior Labs Inc. All rights reserved.</p>
