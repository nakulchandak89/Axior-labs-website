...
export function Problem() {
  ...
  return (
    <section id="problem" className="py-24 md:py-[120px] bg-white relative">
      <div className="max-w-[1200px] w-full mx-auto px-6">
        ...
        <div className="mb-16 md:mb-24 text-center max-w-[800px] mx-auto flex justify-center flex-col items-center">
          ...
          >
            Your operations are generating intelligence.<br className="hidden md:block" />
          ...
          >
            Most organizations have digitized their information systems. Their physical operations are still running blind.
          </motion.p>
        </div>
