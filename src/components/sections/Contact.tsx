...
export function Contact() {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        if (data.errors && Array.isArray(data.errors)) {
          setErrorMessage(data.errors[0].message || 'Please check your inputs and try again.');
        } else {
  ...
  return (
    <section id="contact" className="py-24 md:py-[120px] bg-slate-50 border-t border-slate-100">
      <div className="max-w-[1200px] w-full mx-auto px-6">
        ...
        <div className="mb-16 md:mb-20 text-center max-w-[800px] mx-auto flex justify-center flex-col items-center">
          ...
          >
            Have a question or want to learn more about how we can help upgrade your systems? Drop us a message.
          </motion.p>
        </div>
