...
export function CTA() {
  return (
    <section id="cta" className="py-24 md:py-[120px] bg-white border-t border-slate-100">
      <div className="max-w-[800px] w-full mx-auto px-6 text-center">
        ...
        >
          Talk to our team about what operational intelligence could look like for your organization.
        </motion.p>
        ...
        >
           ...
           <p className="mt-6 font-sans text-sm font-medium text-slate-400 max-w-[300px]">
             No commitment. No generic pitch deck. A focused conversation about your operations.
           </p>
        </motion.div>
