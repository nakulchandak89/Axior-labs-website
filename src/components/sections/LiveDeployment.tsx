    ...
    <section className="py-24 md:py-[120px] bg-white relative overflow-hidden border-t border-slate-100">
      ...
      <div className="max-w-[1000px] w-full mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex justify-center mb-8">
          <SectionLabel label="Live Deployment" className="" />
        </div>
        ...
        >
          From invisible to observable —<br />
        ...
        >
          Axior Pulse is live at an institutional campus, tracking student movement and presence across 25 operational zones in real time. What was previously managed through manual processes and guesswork is now a continuously observable, data-driven operational environment.
        </motion.p>
        ...
        >
          ...
          <div className="flex-1 p-8 md:p-12 flex flex-col justify-center items-center h-full min-h-[160px] md:min-h-0 bg-white m-2 rounded-2xl">
             ...
             <div className="font-sans text-[13px] font-bold uppercase tracking-widest text-emerald-600 text-center">
                Real-Time<br />Visibility<br />Across Campus
             </div>
          </div>
        </motion.div>
        ...
        >
            <div className="flex items-center -space-x-2">
              ...
              <div className="pl-4 text-sm font-medium text-slate-500 font-sans text-left">
                <span className="font-bold text-slate-900">4 enterprise deployments</span> in active pipeline<br className="hidden md:block"/> across manufacturing, logistics, and smart facilities.
              </div>
            </div>
        </motion.div>
