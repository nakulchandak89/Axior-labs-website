    ...
    <section className="py-24 md:py-[120px] bg-white border-t border-slate-100 overflow-hidden">
      <div className="max-w-[1200px] w-full mx-auto px-6">
        ...
        <div className="max-w-[640px] mb-16">
          ...
          >
            Every layer of the stack,<br />
            <span className="text-indigo-600">built for operational reality.</span>
          </motion.h2>
          ...
          >
            We don't assemble third-party tools and call it a platform. We engineer integrated systems where every component is designed to work as a unified operational intelligence layer.
          </motion.p>
        </div>

        <div className="relative -mx-6 px-6 md:mx-0 md:px-0">
          {/* Horizontal scroll container on mobile, flex on desktop */}
          <div className="overflow-x-auto pb-6 md:pb-0 hide-scrollbar" style={{ WebkitOverflowScrolling: 'touch' }}>
            <motion.div 
              ref={ref}
              className="flex items-center w-max md:w-auto md:flex-wrap gap-y-6"
            >
