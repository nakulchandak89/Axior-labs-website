export const SITE_META = {
  ...
  description: 'Axior Labs builds the intelligence layer that makes physical operations observable, measurable, and data-driven. RFID, IoT, AI-powered operational platforms.',
};
...
export const HUB_NODES = [
  ...
  { id: 'equipment', label: 'Equipment', angle: 120, color: '#4F46E5' },
  { id: 'facilities', label: 'Facilities', angle: 180, color: '#4F46E5' },
  { id: 'workflows', label: 'Workflows', angle: 240, color: '#2563EB' },
  { id: 'analytics', label: 'Analytics', angle: 300, color: '#22D3EE' },
];
...
export const INDUSTRIES = [
  {
    ...
    live: true,
    features: 'Campus intelligence, access management, asset tracking, facility visibility.',
  },
  {
    title: 'MANUFACTURING & INDUSTRY 4.0',
    live: false,
    features: 'Production visibility, equipment monitoring, workflow automation, operational intelligence.',
  },
  {
    title: 'LOGISTICS & SUPPLY CHAIN',
    live: false,
    features: 'Asset tracking, inventory visibility, operational coordination, distribution intelligence.',
  },
  {
    title: 'ENTERPRISE & CORPORATE',
    live: false,
    features: 'Workforce intelligence, operational analytics, process automation, facility management.',
  },
  {
    title: 'SMART INFRASTRUCTURE',
    live: false,
    features: 'Connected facility systems, infrastructure monitoring, resource optimization.',
  },
  {
    title: 'HEALTHCARE & INSTITUTIONAL',
    live: false,
    features: 'Asset management, personnel tracking, compliance monitoring, operational visibility.',
  },
];
